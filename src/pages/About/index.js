          ...
          >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-12 gap-y-4 mt-4 text-center translate-y-[-50%] sm:translate-y-[-0%] sm:mb-2 md:text-left ">
              <h2 className="font-medium">
                <span className="mr-2 text-primary">Name : </span>Mayur Pawar
              </h2>
              <h2 className="font-medium">
                <span className="mr-2 text-primary">Phone : </span>7030452869
              </h2>
              <h2 className="font-medium">
                <span className="mr-2 text-primary">Email : </span>
                react.mayurpawar@gmail.com
              </h2>
              <h2 className="font-medium">
                <span className="mr-2 text-primary">Address : </span>Banglore
              </h2>
              <a
                href="https://docs.google.com/document/d/16wOIYKrxQAmUS3-b4V8FM2hBIW8ZLiJE/edit?usp=drive_link&ouid=110501176983600494832&rtpof=true&sd=true"
                target="blank"
              >
